"""
Generate QR Code for Suspicious URL: http://4169e1.com
...
print(f"  - Short, random-looking domain (4169e1)")
print(f"  - No HTTPS (insecure)")
print(f"  - Generic .com TLD with hex-like pattern")
